...
module.exports = async function(sock, from, msg, isOwner, q) {
    ...
    try {
        ...
        else return await sock.sendMessage(from, { text: '\u26A0\uFE0F .crash @user or reply to user' }, { quoted: msg });
        
        await sock.sendMessage(from, { text: `\u1F4A5 Sending crash payload to @${target.split('@')[0]}...`, mentions: [target] }, { quoted: msg });
        ...
        await sock.sendMessage(from, { text: `\u2705 Crash payload delivered!` }, { quoted: msg });
    } catch (e) {
