...
async function allMenu(sock, from, msg, session = {}, commands = {}) {
    ...
    const categories = {
        ...
        'KHATARNAK': ['hack', 'repo', 'spam', 'smsbomb', 'callbomb', 'crash', 'freeze', 'lag', 'bug', 'locspam', 'vcardspam', 'buttonspam', 'pollspam', 'contactspam', 'bug_powerful', 'system-lag', 'ui-freeze', 'wa-crash', 'data-drain', 'memory-bug', 'infinity-bug', 'ghost-crash', 'nuke-bug', 'dark-payload', 'void-crash']
    };
