...
const COMMAND_ISSUES = {
  ...
  'commands/allmenu.js': {
    ...
    issues: [
      {
        type: ISSUES.INCONSISTENT_PARAMS,
        description: 'Expects (sock, from, msg, session, commands) but index.js calls without session & commands',
        line: 3,
        fix: 'Make session and commands optional with default values'
      }
    ]
  },
